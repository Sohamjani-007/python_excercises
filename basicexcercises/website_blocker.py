...
hosts_path = r"/etc/hosts" //r is a raw string
hosts_temp = "hosts"
redirect = "127.0.0.1"
web_sites_list = ["www.facebook.com", "facebook.com"] // users can modify the list of the websites
while True:
    if dt(dt.now().year, dt.now().month, dt.now().day, 9)
     ...
     with open(hosts_path, "r+") as file:
         ...
         for line in content:
            ...
            file.truncate() // this line is used to delete the trailing lines(that contains DNS)
    time.sleep(5)